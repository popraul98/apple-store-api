...
class AppStoreServerApiDecorator implements AppStoreServerAPIInterface
{
    ...
    const PRODUCTION_BASE_URL_EXTERNAL_API = 'https://api.storekit.apple.com/externalPurchase';
    const SANDBOX_BASE_URL_EXTERNAL_API = 'https://api.storekit-sandbox.apple.com/externalPurchase';
